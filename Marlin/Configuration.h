...
//SPJ's edits: 
//1. PID_FUNCTIONAL_RANGE = 20 (was 25)
//2. PID_K1 = 0.85 (was 0.95)
//3. Define Extra probing ON (Was off)
//4. Define PROBING_BED_TEMP     60 (was 50)
//5. Define LEVELING_BED_TEMP     60 (was 50)
//6. Define PREHEAT_1_TEMP_HOTEND 205 (was 200)
//7. Define PREHEAT_2_TEMP_HOTEND 240 (was 240)
//8. #define DEFAULT_AXIS_STEPS_PER_UNIT   {  80, 160, 400, 663} (was 80,80,400,95)
//
//===========================================================================
//============================= Getting Started =============================
//===========================================================================
...
#define Z_PROBE_FEEDRATE_FAST ((4 * 60)/2) //Is 2 for CF, 1 for stock
...
#define PROBE_TARE
  ...
  #define PROBE_TARE_DELAY 250    // (ms) Delay after tare before probing
